...
const fetchDefaultValue = async (assignmentId: string, setHasFetchedDefault: Dispatch<SetStateAction<boolean>>) => {
...
export const EditAssignmentForm: FC<Props> = (props) => {
	...
	const form = useForm<FormSchema>({
		...
		defaultValues: async () => fetchDefaultValue(props.editting, setHasFetchedDefault)
	});
